registerQmlType({
  ...
  constructor(meta) {
    ...
    this.xChanged.connect(this, this.$updateHGeometry);
    this.yChanged.connect(this, this.$updateVGeometry);
    this.widthChanged.connect(this, this.$updateHGeometry);
    this.heightChanged.connect(this, this.$updateVGeometry);
    this.implicitWidthChanged.connect(this, this.$updateHGeometry);
    this.implicitHeightChanged.connect(this, this.$updateVGeometry);
  ...
  onDataChanged(newData) {
    for (const i in newData) {
      ...
      if (child.hasOwnProperty("parent")) {
        // Seems to be an Item. TODO: Use real inheritance and ask using instanceof.
  ...
  $updateHGeometry(newVal, oldVal, propName) {
    ...
    if ((t = anchors.fill) !== undefined) {
        if (!t.$properties.left.changed.isConnected(this, this.$updateHGeometry))
            t.$properties.left.changed.connect(this, this.$updateHGeometry);
        if (!t.$properties.right.changed.isConnected(this, this.$updateHGeometry))
            t.$properties.right.changed.connect(this, this.$updateHGeometry);
        if (!t.$properties.width.changed.isConnected(this, this.$updateHGeometry))
            t.$properties.width.changed.connect(this, this.$updateHGeometry);
        ...
        if (!t.$properties.horizontalCenter.changed.isConnected(this, this.$updateHGeometry))
            t.$properties.horizontalCenter.changed.connect(this, this.$updateHGeometry);
        ...
        if (this.parent && !this.parent.$properties.left.changed.isConnected(this, this.$updateHGeometry))
            this.parent.$properties.left.changed.connect(this, this.$updateHGeometry);
  ...
  $updateVGeometry(newVal, oldVal, propName) {
    ...
    // Position TODO: Layouts
    if ((t = anchors.fill) !== undefined) {
        if (!t.$properties.top.changed.isConnected(this, this.$updateVGeometry))
            t.$properties.top.changed.connect(this, this.$updateVGeometry);
        if (!t.$properties.bottom.changed.isConnected(this, this.$updateVGeometry))
            t.$properties.bottom.changed.connect(this, this.$updateVGeometry);
        if (!t.$properties.height.changed.isConnected(this, this.$updateVGeometry))
            t.$properties.height.changed.connect(this, this.$updateVGeometry);
        ...
        if (!t.$properties.verticalCenter.changed.isConnected(this, this.$updateVGeometry))
            t.$properties.verticalCenter.changed.connect(this, this.$updateVGeometry);
        ...
        if (this.parent && !this.parent.$properties.top.changed.isConnected(this, this.$updateVGeometry))
            this.parent.$properties.top.changed.connect(this, this.$updateVGeometry);
